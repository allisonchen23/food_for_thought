...
![Graph of accuracy of training model from tutorial. It's pretty trash](/assets/images/blog/initial_model_accuracy.png){:class="images half"}
...
![Graphs of accuracy over epochs for model with training sample of 200 total images](/assets/images/blog/training_100.png){:class="images half"}
...
![Graph of accuracy over epochs with learning rate at 0.0001](/assets/images/blog/decreased_lr.png){:class="images half"}
...
![Nice flower by museum](/assets/images/blog/flower.jpg){:class="images half"}
